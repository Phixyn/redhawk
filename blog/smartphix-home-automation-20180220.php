...
?>
        ...
        <div class="container" id="main-content">
            <div class="row blog-post">
                ...
                <p>I had a few ideas, mostly revolving around smart LED lights or similar. I saw a <a href="https://youtu.be/tXlDO79F1DU" target="_blank">cool project</a> where a temperature sensor is used to set the color of the lights in the room based on the current temperature. I thought it was pretty neat and wanted to do something similar. My first thought was to use the Philips Hue lights. I am a big fan of Razer peripherals, and recently Philips and Razer have <a href="https://www2.meethue.com/en-gb/friends-of-hue/razer" target="_blank">teamed up</a> with some cool integrations between their products and SDKs.</p>

                <p>As for the temperature sensor, I was given a Phidget board and sensor at <a href="https://www.uos.ac.uk/" target="_blank">University</a> for the project. However, this project had two problems:</p>
                ...
                <h3>Phidget and temperature sensor</h3>
                ...
                <p>The Android app will be written in Java, as I am more familiar with it than <a href="https://kotlinlang.org/" target="_blank">Kotlin</a>. To start with, its sole purpose will be to display the temperature from a single sensor on the network. For the first stage, it should be fine to hardcode the IP address of the server on the app (or specify one in a textfield in the app). Later on, I can expand the server side of the project to include some kind of broadcast service that the app can discover and connect to, most likely using a protocol such as <a href="https://en.wikipedia.org/wiki/Simple_Service_Discovery_Protocol" target="_blank">SSDP.</a></p>

                <h3>Smart LED integration</h3>

                <a href="<?php echo $config['urls']['root']; ?>/static/blog/image-uploads/Philips-Hue-Alexa-Bridge-Control-Smarthome.jpg" target="_blank"><img src="<?php echo $config['urls']['root']; ?>/static/blog/image-uploads/Philips-Hue-Alexa-Bridge-Control-Smarthome.jpg" alt="Philips Hue Alexa Bridge Control" style="width: 35%;height:50%;" /></a>
