...
?>
        ...
        <div class="container" id="main-content">
            <div class="row blog-post">
				...
				<p>On this website you can find out more about me, <a href="<?php echo $config['urls']['pages']['root']; ?>/projects_bootstrap.php" title="Projects">my projects</a> and my hobbies. If you wish to contact me, please be aware that the contact form has not yet been implemented. Use the email address on the <a href="<?php echo $config['urls']['pages']['root']; ?>/contact_bootstrap.php">contact page</a>, or my social media links in the top navigation bar.</p>
